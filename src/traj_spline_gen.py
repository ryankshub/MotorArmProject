...
class TrajectorySplineGenerator:
    ...
    def generate_trajectory(self, target_angle, current_angle):
        ...
        half_samp = self.time_till_step*self.sample_rate*.5
    ...
    def get_pos_setpoint(self, steps, time_window, time_till_step):
        ...
        if steps == -1: 
            ...
            if abs(self._angle) < self.DEGREE_THRES:
                return self._angle
        ...
        if len(self._trajectory) == 0:
            ...
            if abs(degree_range - self._angle) < self.DEGREE_THRES:
                # Swing backward
