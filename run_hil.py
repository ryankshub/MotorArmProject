...
def hil_main(datafile, graph_title, operation_freq=100, time_window_s=4):
    ...
    plot_hil_results(graph_title, log_time, log_angle, log_target, log_steps, log_speeds)
    return 0


def plot_hil_results(title, times, angles, targets, steps, speeds):
    """
    Plot Hil results
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', '--title', type=str, default="HIL Results", help="Graph title of HIL Results")
    args = parser.parse_args()
    hil_main(args.datafile, args.title)
